...
//Clone git repository
  git url:'https://github.com/azran4u/nodejs-kubernetes-jenkins-demo.git'
   }
stage('Integration') {
 
      withKubeConfig([credentialsId: 'jenkins-deployer-credentials', serverUrl: 'https://localhost']) {
